...
class ArchivoIndicador30 extends Component
{
    use WithFileUploads;
    ...
    public function mount($id_indicador, $id_evaluacion)
    {
        ...
        foreach ($this->fuentesInformaciones as $fuente) {
            ...
            $this->archivo_url[$fuente->id] = isset($arch_gestion_calidad->archivo) ? $arch_gestion_calidad->archivo : null;
    ...
    {
        return view('livewire.criterio6.archivo-indicador30.view');
    }

    public function guardarArchivoIndicador30()
    {
