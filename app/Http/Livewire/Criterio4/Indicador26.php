...
class Indicador26 extends Component
{
    ...
    public function mount($id_indicador, $id_evaluacion)
    {
        ...
        $res_indicador_26 = ResIndicador26::where('evaluacion_id', $this->evaluacion_id)->where('indicador_id', $this->indicador_id)->first();
        // PARA CALCULAR PAC
    ...
    {
        return view('livewire.criterio4.indicador26.view');
    }
