...
<div class="row">
    <div class="col-sm-11" style="width: 95%">
        ...
        <div class="card">
            ...
            @endphp
            @if (auth()->user()->can("$evaluacion->id/$ind_cri_id")||auth()->user()->can('admin') || auth()->user()->can("$evaluacion->id-$indicador->id"))
        ...
        @endphp
        @if (auth()->user()->can("$evaluacion->id/$ind_cri_id")||auth()->user()->can('admin') || auth()->user()->can("$evaluacion->id-$indicador->id") || auth()->user()->can("CriteriaR"))
        <div class="card-body" id="indicador_{{ $indicador->id }}" style="padding-top: 25px;">
            <h5 class="card-title mt-3" style="color: #0c63e4">{{ $indicador->indicador }} <b
                    style="margin-left: 20px; color: red;">{{ $indicador->porcentaje }} %</b>
            </h5>
