<div>
            ...
            <div class="card-body mt-3">
                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle text-uppercase pt-2 pb-2">
                        ...
                        <tbody>
                            @if ($arch_investigaciones->count() == 0)
                                <tr>
                            ...
                            @else
                                @foreach ($arch_investigaciones as $arch_investigacion)
                                    <tr>
                                        <td>
                                            {{ $loop->iteration }}
                                        </td>
                                        <td>
                                            {{ $arch_investigacion->observacion }}
                                        </td>                                        
                                        <td>
                                            @isset($arch_investigacion)
                                                @if ($arch_investigacion->archivo != '')
                                                    <a class="text-actualizar" title="Descargar" target="_blank"
                                                        href="{{ asset('storage') . '/' . $arch_investigacion->archivo }}"><i class="fas fa-eye"></i> Ver
                                                    </a>
                                                @else
    ...
    {{-- MODALES --}}
    @include('livewire.criterio4.fuente26.modal')
</div>
