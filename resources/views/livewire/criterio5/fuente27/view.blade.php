<div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle text-uppercase pt-2 pb-2">
                        ...
                        <tbody>
                            ...
                            @else
                                @foreach ($arch_vinculaciones as $arch_vinculacion)
                                    <tr>
                                        <td>
                                            {{ $loop->iteration }}
                                        </td>
                                        <td>
                                            {{ $arch_vinculacion->observacion }}
                                        </td>                                        
                                        <td>
                                            @isset($arch_vinculacion)
                                                @if ($arch_vinculacion->archivo != '')
                                                    <a class="text-actualizar" title="Descargar" target="_blank"
                                                        href="{{ asset('storage') . '/' . $arch_vinculacion->archivo }}"><i class="fas fa-eye"></i> Ver
                                                    </a>
                                                @else
    ...
    {{-- MODALES --}}
    @include('livewire.criterio5.fuente27.modal')
</div>
