        ...
        <div class="col-sm-11" style="width: 95%">
            ...
            <div class="card">
                @foreach ($indicadores as $indicador)
                    @if ($indicador->id == 27 || $indicador->id == 28)
                            ...
                            <div class="accordion" id="">
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapse_{{ $indicador->id }}" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            @php
                                                $componentName = 'criterio5.indicador' . $indicador->id;
                                            @endphp                                            
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapse_fi_{{ $indicador->id }}" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            @php
                                                $componentName = 'criterio5.archivo-indicador' . $indicador->id;
                                            @endphp
                                            @livewire($componentName, ['id_indicador' => $indicador->id, 'id_evaluacion' => $evaluacion->id])
                                        </div>
                                    </div>
        ...
        <div class="col-sm-1" style="width: 5%">
            <aside id="sidebar" class="" style="position: fixed">
                <ul class="sidebar-nav" id="sidebar-nav">
                    <li class="nav-item">
                        <a class="nav-link collapsed" id="inicio" href="#indicador_27">
                            <i class="bi bi-arrow-return-left"></i><span>27</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link collapsed" id="inicio" href="#indicador_28">
                            <i class="bi bi-arrow-return-left"></i><span>28</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link collapsed" id="inicio" href="#indicador_29">
                            <i class="bi bi-arrow-return-left"></i><span>29</span>
                        </a>
                    </li>
                </ul>
            </aside>
