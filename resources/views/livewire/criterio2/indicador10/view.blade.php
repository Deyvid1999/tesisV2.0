                ...
                <tr class="table-light">
                    ...
                    <th>
                        <button type="button" class="btn btn-actualizar" data-bs-toggle="tooltip" data-bs-placement="top"
                            title="Mayor o igual al umbral normativo en todos sus periodos académcios">
                            S
                        </button>
                        <button type="button" class="btn btn-eliminar" data-bs-toggle="tooltip" data-bs-placement="top"
                            title="Menor al umbral normativo en alguno de sus perídos académicos">
                            D
                        </button>
                    </th>
                    <th></th>
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <div class="d-flex justify-content-end">
                    <button type="button" wire:click.prevent="guardarIndicador10()"
...
@push('scripts')
    <script>        
        document.getElementById('criterio_2').classList.remove('collapsed');
    </script>
@endpush
