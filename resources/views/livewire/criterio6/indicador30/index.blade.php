...
@section('content')
    <div class="row">
        <div class="col-sm-11" style="width: 95%">
            <div class="pagetitle">
                <h3>{{ $criterio->criterio }} <b style="margin-left: 20px; color: red;">{{ $criterio->porcentaje }}
                        %</b></h3>
            </div>
            <div class="card">
                        ...
                        <div class="accordion" id="">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapse_{{ $indicador->id }}" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        @php
                                            $componentName = 'criterio6.indicador' . $indicador->id;
                                        @endphp
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapse_fi_{{ $indicador->id }}" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        @php
                                            $componentName = 'criterio6.archivo-indicador' . $indicador->id;
                                        @endphp
                                        @livewire($componentName, ['id_indicador' => $indicador->id, 'id_evaluacion' => $evaluacion->id])
                                    </div>
                                </div>
        ...
        <div class="col-sm-1" style="width: 5%">
            <aside id="sidebar" class="" style="position: fixed">
                <ul class="sidebar-nav" id="sidebar-nav">
                    <li class="nav-item">
                        <a class="nav-link collapsed" id="inicio" href="#indicador_30">
                            <i class="bi bi-arrow-return-left"></i><span>30</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link collapsed" id="inicio" href="#indicador_31">
                            <i class="bi bi-arrow-return-left"></i><span>31</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link collapsed" id="inicio" href="#indicador_32">
                            <i class="bi bi-arrow-return-left"></i><span>32</span>
                        </a>
                    </li>
                </ul>
            </aside>
