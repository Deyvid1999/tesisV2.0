    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header bg-crear text-white pb-2 pt-2">
                <h6 class="modal-title fw-normal text-uppercase">Asignar responsable de {{$criterio->criterio}}</h6>
            ...
            <div class="modal-body">
                <form method="POST" action="{{ url('criteria-assignments') }}" enctype="multipart/form-data">
                    ...
                    <input type="hidden" value="{{$evaluacion->id}}" id="evaluacionId" name="evaluacion_id">
                    <input type="hidden" id="criterioId" name="criterio_id">
