        ...
        <div class="card mb-3">
            ...
            <div class="card-body pt-3" style="margin-top: 20px;">
                <div class="row text-center">
                    <div class="col-sm-4">
                        @if ($total_criterios[$criterio->id] >= 80)
                    ...
                    <div class="col-sm-8">
                        <h2 style="font-size: 40px;  color:{{ $total_criterios[$criterio->id] >= 80 ? '#00c851' : '#ff3547' }}">
                ...
                <div class="progress">
                    <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar"
                        style="width: {{ $total_criterios[$criterio->id] }}%; background-color: {{ $total_criterios[$criterio->id] >= 80 ? '#00c851' : '#ff3547' }};"
