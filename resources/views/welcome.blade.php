...
<body>
    ...
    <header id="header" class="fixed-top ">
        <div class="container d-flex align-items-center">
            ...
            <h1 class="logo me-auto"><a href="" class="logo me-auto"><img src="img/Logo_ESPE.png" alt=""
                        class="img-fluid" style="
                padding-right: 10px;"></a></h1>
    ...
    <section id="hero" class="d-flex align-items-center">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-10">
                    <h2 style="color: white; font-size:30px"><span class="typed"></span></h2>
